...
const facultyMembers: FacultyMember[] = [
  ...
  {
    name: "Brandon Lopez, AIA Assoc, ASID",
    title: "Architectural Designer",
    credentials: "Master of Architecture, SCI-Arc",
    specialization: "Architecture & Visualization",
    bio: "Architectural designer experienced in professional and freelance settings. Creates high-quality architectural drawings, 3D models, and visualizations, with a talent for mentoring others through creative and technical challenges. Currently contributing to high-end residential projects at Office Other Walls in LA.",
    imageSrc: "/images/faculty/brandon-lopez.jpg",
    specialties: ["Architecture", "3D Visualization", "Residential"],
  },
  {
    name: "Cynthia Prizant, ASID, CID, LEED",
    title: "Green Building Certified Designer",
    credentials: "BS Computer Science, University of Pittsburgh; AA Interior Design, Interior Designers Institute",
    specialization: "Sustainable & Green Design",
    bio: "Served on the ASID Orange County California Board as Professional Development Director. Has worked in the field since 1989; in 2007 opened her own design firm.",
    imageSrc: "/images/faculty/cynthia-prizant.jpg",
    specialties: ["ASID", "LEED", "Green Building"],
  },
  {
    name: "Kate Saunders, Allied ASID, CID, NKBA",
    title: "Design Leadership Consultant",
    credentials: "Master of Architecture, New School of Architecture and Design",
    specialization: "Architecture & Design Leadership",
    bio: "With over 20 years of industry experience, Kate has worked in construction management, architecture, and design leadership, including roles at RH and with top Southern California designers. Her outsourcing service now gives independent designers access to resources once limited to large firms.",
    imageSrc: "/images/faculty/kate-saunders.jpg",
    specialties: ["Architecture", "NKBA", "Design Leadership"],
  },
  {
    name: "Michele Prata",
