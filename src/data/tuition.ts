...
export const tuitionData: TuitionInfo[] = [
  // ─── Certificate Course ──────────────────────────────────────────────────────
  {
    ...
    notes: [
      ...
      "Total estimated cost of $2,940 includes books and supplies not included in total charges.",
  ...
  // ─── Associate of Arts Degree ────────────────────────────────────────────────
  {
    ...
    notes: [
      "Registration fee of $100 is non-refundable and paid once.",
      "Supply cost of $500 covers specialized design materials and equipment.",
      "Total estimated cost of $43,000 includes books, supplies, and other expenses not included in total charges.",
  ...
  // ─── Bachelor of Arts Degree ─────────────────────────────────────────────────
  {
    ...
    notes: [
      ...
      "Registration fee of $100 is non-refundable (paid once if continuing from AA program).",
      "Supply cost of $700 covers advanced materials and equipment.",
      "Total estimated cost of $23,250 includes books, supplies, and other expenses.",
